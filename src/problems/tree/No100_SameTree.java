...
public class No100_SameTree {
    ...
    public static void main(String[] args) {
        No100_SameTree solution = new No100_SameTree();
        //构造测试用例1
        ...
        System.out.println("p==q : " + solution.isSameTree(p, q));
        System.out.println("p==q : " + solution.isSameTreeNonRecursive(p, q));
        ...
        System.out.println("p2==q2 : " + solution.isSameTree(p2, q2));
        System.out.println("p2==q2 : " + solution.isSameTreeNonRecursive(p2, q2));
    }
}
