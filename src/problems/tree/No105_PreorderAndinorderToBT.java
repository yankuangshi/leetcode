 ...
 * @date 2020/1/2
 */
public class No105_PreorderAndinorderToBT {
    ...
    public static void main(String[] args) {
        No105_PreorderAndinorderToBT solution = new No105_PreorderAndinorderToBT();
        int[] preorder = {3, 9, 20, 15, 7};
        int[] inorder = {9, 3, 15, 20, 7};
        System.out.println("buildTree: " + solution.buildTree(preorder, inorder));
    }
}
