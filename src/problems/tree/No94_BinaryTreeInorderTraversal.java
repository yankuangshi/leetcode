...
public class No94_BinaryTreeInorderTraversal {
     ...
     * @return
     */
    public List<Integer> inorderTraversalNonRecursively(TreeNode root) {
        List<Integer> list = new ArrayList<>();
...
//        }
    ...
    public List<Integer> inorderTraversalNonRecursively2(TreeNode root) {
        List<Integer> list = new ArrayList<>();
        if (root == null) return list;
    ...
    public static void main(String[] args) {
        ...
        No94_BinaryTreeInorderTraversal solution = new No94_BinaryTreeInorderTraversal();
        System.out.println(solution.inorderTraversal(root));
        System.out.println(solution.inorderTraversalNonRecursively(root));
        System.out.println(solution.inorderTraversalNonRecursively2(root));
    }
}
