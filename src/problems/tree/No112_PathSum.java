...
public class No112_PathSum {
    ...
    public static void main(String[] args) {
        ...
        No112_PathSum solution = new No112_PathSum();
        System.out.println("hasPathSum=" + 22 + " : " + solution.hasPathSum(root, 22));
        System.out.println("hasPathSum=" + 22 + " : " + solution.hasPathSumNonRecursive(root, 22));
    }
}
